        ...
        <>
          <Box className={wrap}>
            ...
            <svg className={`${scroll} ${spinAgain}`} width="24" height="34" viewBox="0 0 24 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M12.41 9.727c-.603 0-1.092.444-1.092.992v3.47c0 .549.489.993 1.091.993.603 0 1.091-.444 1.091-.992v-3.471c0-.548-.488-.992-1.09-.992z" fill="#fff" stroke="#395DAD" stroke-width=".3"></path>
            </svg>
            </Box>
          </Box>
        </>
